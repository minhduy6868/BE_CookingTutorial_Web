...
public class SecurityConfig {
    ...
    private final String[] GET_ENDPOINTS = {"/post/{post_id}", "/post/search", "/post/getAllPost","user/info/{userId}","/post/file/{fileName:.+}","/post/topDislikePost", "/post/getPost/{typePost}", "/post/getPostByTypePost/{typePost}"};
